...
describe('ExecutiveComponent', () => {
  ...
  it('should call grouping kpi functions when filterdata is available', () => {
    ...
    let spyJenkins = spyOn(component, 'groupJenkinsKpi');
    let spyZypher = spyOn(component, 'groupZypherKpi');
    let spyJira = spyOn(component, 'groupJiraKpi');
    let spyBitBucket = spyOn(component, 'groupBitBucketKpi');
    let spySonar = spyOn(component, 'groupSonarKpi');
    component.receiveSharedData(event);
  ...
  it('should make post Sonar call', fakeAsync(() => {
    ...
    let spy = spyOn(component, 'afterSonarKpiResponseReceived');
  ...
  it('should make post Jenkins call', fakeAsync(() => {
    ...
    spyOn(httpService, 'postKpi').and.returnValue(of(postData.kpiList));
    let spy = spyOn(component, 'createAllKpiArray');
