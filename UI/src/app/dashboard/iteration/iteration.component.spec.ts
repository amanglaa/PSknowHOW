...
describe('IterationComponent', () => {
  ...
  beforeEach  (() => {
    ...
    reqJira = httpMock.match((request) => {
      return request.url;
    });
  ...
  component.selectedtype ='Scrum';
  let spygroupJiraKpi =spyOn(component,'groupJiraKpi');
  let spycalcBusinessDays =spyOn(component,'calcBusinessDays');
  ...
  it('postJiraKpi should call httpServicepost',fakeAsync(()=>{
    ...
    let spy=spyOn(httpService,'postKpi').and.returnValue(of(fakeJiraGroupId1));
    let spycreateKpiWiseId =spyOn(helperService,'createKpiWiseId').and.returnValue(jiraKpiData);
    let spycreateAllKpiArray =spyOn(component,'createAllKpiArray');
  ...
  it('should call downloadExcel',()=>{
    ...
    let spy = spyOn(helperService,'downloadExcel');
  ...
  it('should return video link for kpi',()=>{
    ...
    let result =component.getVideoLink('kpi14');
  ...
  it('should check if video link is available',()=>{
    ...
    let result = component.isVideoLinkAvailable('kpi14');
  ...
  it('should return the count of items selected',()=>{
    ...
    let result =component.checkItemsSelected(obj);
  ...
  it('should check if kpi exists',()=>{
    ...
    let result = component.ifKpiExist('kpi13');
  ...
  it('should process kpi config data on onTypeRefresh',()=>{
    ...
    let spy =spyOn(component,'processKpiConfigData');
