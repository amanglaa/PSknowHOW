...
package com.publicissapient.kpidashboard.azurepipeline.model;
 ...
 */
public class AzurePipelineJob extends JobProcessorItem {
	...
	public boolean equals(Object obj) {
		...
		AzurePipelineJob azurePipelineJob = (AzurePipelineJob) obj;

		return getInstanceUrl().equals(azurePipelineJob.getInstanceUrl())
				&& getJobName().equals(azurePipelineJob.getJobName());
	}
