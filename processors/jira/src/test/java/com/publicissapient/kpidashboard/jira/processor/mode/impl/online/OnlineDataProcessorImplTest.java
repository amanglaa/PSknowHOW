...
public class OnlineDataProcessorImplTest {
	...
	private List<JiraIssueCustomHistory> createJiraIssueHistoryData() {
		...
		List<JiraIssueSprint> issueSprintList = new ArrayList<>();
		JiraIssueSprint jiraIssueSprint = new JiraIssueSprint();
		jiraIssueSprint.setSprintId("Test Sprint 1");
		jiraIssueSprint.setSprintComponentId("12345_Test Project");
		jiraIssueSprint.setActivityDate(DateTime.now());
		jiraIssueSprint.setFromStatus("In Development");
		issueSprintList.add(jiraIssueSprint);

		jiraIssueCustomHistory.setStorySprintDetails(issueSprintList);
