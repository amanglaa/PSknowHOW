...
public final class JiraIssueClientUtil {
     ...
     *
     * @param changeDateISO       ISO date String
    ...
    public static String getChangeDateMinutePrior(String changeDateISO, JiraProcessorConfig jiraProcessorConfig) {
        ...
        return JiraProcessorUtil.getFormattedDateString(
                JiraProcessorUtil.getTimeAdjustedDate(JiraProcessorUtil.getFormattedDateTime(changeDateISO), priorMinutes));
    }
     ...
     * @param accountHierarchyRepository accountHierarchyRepository
