...
public class OfflineAdapter implements JiraAdapter {
     ...
     * @param searchResult Atlassian SearchResult instance
     * @param version list of version for a Jira
     */
     ...
     * @param dataExist data exist on db or not
    ...
    public SearchResult getIssues(BoardDetails boardDetails, ProjectConfFieldMapping projectConfig,
        ...
        if (jiraRawRs != null) {
            ...
            log.info(String.format("Processing issues %d - %d out of %d", pageStart, pageEnd,
